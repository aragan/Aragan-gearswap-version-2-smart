...
engaging = os.clock()
include('Ara-MonsterAbilities.lua')
...
CureAbility = S{"Cure","Cure II","Cure III","Cure IV","Cure V","Cure VI","Restoral","White Wind","Magic Fruit","Wild Carrot","Plenilune Embrace","Curaga","Curaga II",
