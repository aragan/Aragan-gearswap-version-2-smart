...
function check_cleanup()
	if state.AutoCleanupMode.value then
		...
		if items.count_sack < items.max_sack then
			...
			if player.inventory['Ctn. Purse (Alx.)'] then send_command('put "Ctn. Purse (Alx.)" sack all') moveditem = true end
			if player.inventory['Lin. Purse (Alx.)'] then send_command('put "Lin. Purse (Alx.)" sack all') moveditem = true end

			if player.inventory['Tukuku whiteshell'] then send_command('put "Tukuku whiteshell" sack all') moveditem = true end
			if player.inventory['One byne bill'] then send_command('put "One byne bill" sack all') moveditem = true end
			if player.inventory['Ordelle Bronzepiece'] then send_command('put "Ordelle Bronzepiece" sack all') moveditem = true end
			if player.inventory['100 Byne Bill'] then send_command('put "100 Byne Bill" sack all') moveditem = true end
			if player.inventory['M. Silverpiece'] then send_command('put "M. Silverpiece" sack all') moveditem = true end
			if player.inventory['L. Jadeshell'] then send_command('put "L. Jadeshell" sack all') moveditem = true end
