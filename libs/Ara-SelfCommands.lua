...
function handle_set(cmdParams)
    if #cmdParams == 0 then
        add_to_chat(123,'Ara-Libs: Set parameter failure: field not specified.')
        return
    end
	...
	if state_var then
		...
		if cmdParams[2] then
			...
			add_to_chat(123, 'Ara-Libs: Set parameter failure: value not specified for [' .. cmdParams[1] .. '].')
			return
		end
        ...
        add_to_chat(123,'Ara-Libs: Set: Unknown field ['..cmdParams[1]..']')
    end
...
function handle_reset(cmdParams)
    ...
    elseif job_reset_state then
        ...
        add_to_chat(123,'Ara-Libs: Reset: Unknown field ['..cmdParams[1]..']')
    end
end
...
function handle_cycle(cmdParams)
    if #cmdParams == 0 then
        add_to_chat(123,'Ara-Libs: Cycle parameter failure: field not specified.')
        return
    end
    ...
    if state_var then
        ...
        add_to_chat(123,'Ara-Libs: Cycle: Unknown field ['..cmdParams[1]..']')
    end
end
...
function handle_toggle(cmdParams)
    if #cmdParams == 0 then
        add_to_chat(123,'Ara-Libs: Toggle parameter failure: field not specified.')
        return
    end
    ...
    if state_var then
        ...
        add_to_chat(123,'Ara-Libs: Toggle: Unknown field ['..cmdParams[1]..']')
    end
end
...
function handle_unset(cmdParams)
    if #cmdParams == 0 then
        add_to_chat(123,'Ara-Libs: Unset parameter failure: field not specified.')
        return
    end
